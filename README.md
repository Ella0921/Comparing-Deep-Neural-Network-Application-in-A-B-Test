...
```bibtex
@misc{tsai2024abtestdnn,
  title       = {A/B Test: MLP vs Decentralised Factorial Designs},
  author      = {Tsai, Yin-Wen},
  year        = {2024},
  institution = {CUHK SRPP — Dept. of Systems Engineering and Engineering Management}
}
```
